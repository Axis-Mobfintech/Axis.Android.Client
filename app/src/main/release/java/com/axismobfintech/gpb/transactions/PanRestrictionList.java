...
public final class PanRestrictionList {
  private PanRestrictionList() {}
  public static void registerAllExtensions(
      com.google.protobuf.ExtensionRegistryLite registry) {
  }
  public interface PrimaryAccountNumberBlackListOrBuilder extends
      // @@protoc_insertion_point(interface_extends:axis.transactions.PrimaryAccountNumberBlackList)
  ...
  /**
   * Protobuf type {@code axis.transactions.PrimaryAccountNumberBlackList}
   */
  public  static final class PrimaryAccountNumberBlackList extends
      com.google.protobuf.GeneratedMessageLite<
          PrimaryAccountNumberBlackList, PrimaryAccountNumberBlackList.Builder> implements
      // @@protoc_insertion_point(message_implements:axis.transactions.PrimaryAccountNumberBlackList)
      PrimaryAccountNumberBlackListOrBuilder {
  ...
  if (registerDate_ != null &&
    ...
    public static com.axismobfintech.gpb.transactions.PanRestrictionList.PrimaryAccountNumberBlackList parseFrom(
    ...
    public static com.axismobfintech.gpb.transactions.PanRestrictionList.PrimaryAccountNumberBlackList parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return com.google.protobuf.GeneratedMessageLite.parseFrom(
          DEFAULT_INSTANCE, data);
    }
    ...
    public static com.axismobfintech.gpb.transactions.PanRestrictionList.PrimaryAccountNumberBlackList parseFrom(java.io.InputStream input)
    ...
    public static com.axismobfintech.gpb.transactions.PanRestrictionList.PrimaryAccountNumberBlackList parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return parseDelimitedFrom(DEFAULT_INSTANCE, input);
    }
    public static com.axismobfintech.gpb.transactions.PanRestrictionList.PrimaryAccountNumberBlackList parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
    ...
    public static Builder newBuilder(com.axismobfintech.gpb.transactions.PanRestrictionList.PrimaryAccountNumberBlackList prototype) {
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessageLite.Builder<
          com.axismobfintech.gpb.transactions.PanRestrictionList.PrimaryAccountNumberBlackList, Builder> implements
        // @@protoc_insertion_point(builder_implements:axis.transactions.PrimaryAccountNumberBlackList)
        com.axismobfintech.gpb.transactions.PanRestrictionList.PrimaryAccountNumberBlackListOrBuilder {
      // Construct using com.axismobfintech.gpb.transactions.PanRestrictionList.PrimaryAccountNumberBlackList.newBuilder()
      private Builder() {
      ...
      // @@protoc_insertion_point(builder_scope:axis.transactions.PrimaryAccountNumberBlackList)
    }
    @java.lang.Override
    ...
    protected final java.lang.Object dynamicMethod(
      ...
      switch (method) {
        case NEW_MUTABLE_INSTANCE: {
          return new com.axismobfintech.gpb.transactions.PanRestrictionList.PrimaryAccountNumberBlackList();
        }
        case NEW_BUILDER: {
          return new Builder();
        }
        ...
        case GET_PARSER: {
          com.google.protobuf.Parser<com.axismobfintech.gpb.transactions.PanRestrictionList.PrimaryAccountNumberBlackList> parser = PARSER;
          if (parser == null) {
            synchronized (com.axismobfintech.gpb.transactions.PanRestrictionList.PrimaryAccountNumberBlackList.class) {
              parser = PARSER;
              if (parser == null) {
                parser =
                    new DefaultInstanceBasedParser<com.axismobfintech.gpb.transactions.PanRestrictionList.PrimaryAccountNumberBlackList>(
                        DEFAULT_INSTANCE);
                PARSER = parser;
              }
            }
    ...
    // @@protoc_insertion_point(class_scope:axis.transactions.PrimaryAccountNumberBlackList)
    private static final com.axismobfintech.gpb.transactions.PanRestrictionList.PrimaryAccountNumberBlackList DEFAULT_INSTANCE;
    static {
      PrimaryAccountNumberBlackList defaultInstance = new PrimaryAccountNumberBlackList();
      // New instances are implicitly immutable so no need to make
      // immutable.
      DEFAULT_INSTANCE = defaultInstance;
      com.google.protobuf.GeneratedMessageLite.registerDefaultInstance(
        PrimaryAccountNumberBlackList.class, defaultInstance);
    }

    public static com.axismobfintech.gpb.transactions.PanRestrictionList.PrimaryAccountNumberBlackList getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }

    private static volatile com.google.protobuf.Parser<PrimaryAccountNumberBlackList> PARSER;

    public static com.google.protobuf.Parser<PrimaryAccountNumberBlackList> parser() {
